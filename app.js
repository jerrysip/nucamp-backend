...
app.all("*", (req, res, next) => {
  //app.all catches any type of request coming into the server, use asterisk for wildcard request
  if (req.secure) {
    //.secure is set automatically to true
    return next();
  } else {
    //if not secure, redirect to a secure link
    console.log(
